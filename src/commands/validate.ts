...
import { validateNexus } from '../core/validator/index.js'
...
export function validateCommand(): Command {
  return new Command('validate')
    .description('Validate the syntax and semantics of a .nexus file')
    ...
    .action((file: string) => {
      ...
      if (errors.length === 0) {
        console.log(chalk.green(`✓ ${file} — valid syntax and semantics`))
      } else {
