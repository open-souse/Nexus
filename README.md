...
| Comando | Descripción |
|:---|:---|
| `nexus init` | Crea el **DNA** de tu proyecto (`nexus.config.json`). |
| `nexus context` | Genera `NEXUS.md` como referencia universal para tu IA. |
...
// Generar el prompt para tu LLM (Claude, GPT, etc.)
